# Contributing to dcat-ap-plus

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
dcat-ap-plus. These guidelines are not strict rules.
...
The dcat-ap-plus team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the dcat-ap-plus technical leads
...
[issues]: https://github.com/nfdi-de/dcat-ap-plus/issues/
[pulls]: https://github.com/nfdi-de/dcat-ap-plus/pulls/
